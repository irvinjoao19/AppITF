...
class ComboVisitaAdapter(private val listener: OnItemClickListener.VisitaListener) :
    RecyclerView.Adapter<ComboVisitaAdapter.ViewHolder>() {

    private var menu = emptyList<Visita>()
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(m: Visita, listener: OnItemClickListener.VisitaListener) = with(itemView) {
