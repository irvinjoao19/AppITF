...
class EditUsuarioFragment : DaggerFragment(), View.OnClickListener {
    ...
    private fun bindUI() {
        ...
        itfViewModel.getUsuarioById(personalId).observe(viewLifecycleOwner, {
            if (it != null) {
                p = it
    ...
    private fun spinnerDialog(tipo: Int, title: String) {
        ...
        when (tipo) {
            ...
            4 -> {
                ...
                personalViewModel.getSupervisores().observe(this, {
