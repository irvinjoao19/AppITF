...
class EditEspecialidadFragment : DaggerFragment(), View.OnClickListener {

    override fun onClick(v: View) {
        when (v.id) {
            R.id.fabGenerate -> formEspecialidad()
        }
    }
    ...
    lateinit var p: Especialidad
    private var usuarioId: Int = 0
    private var especialidadId: Int = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        p = Especialidad()
        arguments?.let {
            especialidadId = it.getInt(ARG_PARAM1)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_edit_especialidad, container, false)
    }
    ...
    private fun bindUI() {
        ...
        itfViewModel.getEspecialidadById(especialidadId).observe(viewLifecycleOwner, {
            if (it != null) {
                p = it
    ...
    private fun formEspecialidad() {
        ...
        load()
        itfViewModel.validateEspecialidad(p)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: Int, param2: Int) =
            EditEspecialidadFragment().apply {
