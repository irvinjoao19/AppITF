...
public class TableRejaAdapter extends AbstractTableAdapter<ColumnHeaderModel, RowHeaderModel,
        CellModel> {

    private TableRejaViewModel tableRejaViewModel;

    public TableRejaAdapter(Context p_jContext) {
        super(p_jContext);

        this.tableRejaViewModel = new TableRejaViewModel();
    }
    ...
    public int getCellItemViewType(int position) {
        return tableRejaViewModel.getCellItemViewType(position);
    }

    public void setUserList(List<ProgramacionReja> userList) {
        tableRejaViewModel.generateListForTableView(userList);

        setAllItems(tableRejaViewModel.getColumHeaderModeList(), tableRejaViewModel
                .getRowHeaderModelList(), tableRejaViewModel.getCellModelList());
    }
}